...
interface DoorsWindowsIconProps {
  position: [number, number, number];
  hasDoorsWindows: boolean;
  onToggleDoorsWindows: () => void;
}

export function DoorsWindowsIcon({
  position,
  hasDoorsWindows,
  onToggleDoorsWindows,
}: DoorsWindowsIconProps) {
  ...
  const handleClick = (e: any) => {
    e.stopPropagation();
    showPopup('Deuren, kozijnen en ramen');
    onToggleDoorsWindows();
  };
