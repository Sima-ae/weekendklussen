...
export function LocationContent({ 
  ...
  const structuredData = generateLocalBusinessSchema(location, 'aannemer');
      ...
      <div className="space-y-8">
        ...
        >
          ...
          <p className="text-gray-700 mb-4">
            Weekend Klussen is uw betrouwbare aannemer en bouwbedrijf in {location}. Met jarenlange ervaring in de regio Zuid-Holland verzorgen wij alle bouw- en renovatiewerkzaamheden voor particulieren en bedrijven.
          </p>
          <p className="text-gray-700 mb-4">
