...
interface KeukenAfkittenContentProps {
  location: string;
  title: string;
  description: string;
  nearbyCities?: string[];
...
export function KeukenAfkittenContent({ 
  location, 
  title, 
  description, 
  nearbyCities = []
}: KeukenAfkittenContentProps) {
  const services = [
    'Keuken afkitten rondom',
    'Keukenblad afkitten',
    'Keukenkastjes afkitten',
    'Keuken achterwand afkitten',
    'Oude kit verwijderen en vervangen',
    'Keuken afkitten met hoogwaardige kit',
    'Voegwerk keuken',
    'Keuken afdichten tegen vocht',
    'Keuken afkitten na renovatie',
    'Onderhoud en nazorg',
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="space-y-8">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Keuken afkitten in {location}</h2>
          <p className="text-gray-700 mb-4">
            Weekend Klussen is uw specialist voor keuken afkitten in {location}. Keuken afkitten is essentieel voor een goede afdichting en voorkomt vochtproblemen, schimmelvorming en tocht. Onze ervaren vakmannen zorgen voor een perfecte afwerking met hoogwaardige kitmaterialen.
          </p>
          <p className="text-gray-700 mb-4">
            Wij verzorgen keuken afkitten voor alle onderdelen van uw keuken in {location} en omgeving. Of het nu gaat om het afkitten van het keukenblad, de achterwand, kastjes of naden - wij zorgen voor een strakke en duurzame afwerking. Oude kit wordt zorgvuldig verwijderd en vervangen door nieuwe, hoogwaardige kit.
          </p>
          <p className="text-gray-700">
            Goed afkitten voorkomt vochtdoorslag en zorgt voor een hygiënische en makkelijk schoon te houden keuken. Onze vakmannen in {location} werken met precisie en zorgen voor een perfecte afwerking die jarenlang meegaat.
          </p>
        </motion.section>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Onze keuken afkitten diensten in {location}</h2>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Waarom keuken afkitten belangrijk is</h2>
          <p className="text-gray-700 mb-4">
            Keuken afkitten biedt tal van voordelen:
          </p>
          ...
          <p className="text-gray-700">
            Door professioneel keuken afkitten voorkomt u problemen en zorgt u voor een perfecte afwerking. Onze vakmannen in {location} gebruiken hoogwaardige kitmaterialen die bestand zijn tegen vocht, warmte en schoonmaakmiddelen.
          </p>
        </motion.section>
        ...
        {nearbyCities.length > 0 && (
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              Weekend Klussen verzorgt keuken afkitten niet alleen in {location}, maar ook in de omliggende gemeenten en steden:
            </p>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Waarom kiezen voor Weekend Klussen voor keuken afkitten in {location}?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Jarenlange ervaring met keuken afkitten in {location}.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Altijd garantie op onze keuken afkitten werkzaamheden.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-indigo-100 rounded-lg flex items-center justify-center shrink-0">
        ...
        >
          <h2 className="text-2xl font-bold mb-4">Vrijblijvend offerte voor keuken afkitten in {location}</h2>
          <p className="mb-6 text-indigo-100">
            Heeft u een keuken die afgekit moet worden in {location}? Vraag vrijblijvend een gratis offerte aan. Wij komen graag langs voor een inspectie en reageren binnen 24 uur met een duidelijke prijsopgave zonder verplichtingen.
          </p>
