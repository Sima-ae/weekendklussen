...
interface KeukenbladKittenContentProps {
  location: string;
  title: string;
  description: string;
  nearbyCities?: string[];
...
export function KeukenbladKittenContent({ 
  location, 
  title, 
  description, 
  nearbyCities = []
}: KeukenbladKittenContentProps) {
  const services = [
    'Keukenblad kitten rondom',
    'Keukenblad kitten tegen achterwand',
    'Keukenblad kitten tegen kastjes',
    'Oude kit verwijderen en vervangen',
    'Keukenblad kitten met hoogwaardige kit',
    'Voegwerk keukenblad',
    'Keukenblad afdichten tegen vocht',
    'Keukenblad kitten na plaatsing',
    'Keukenblad kitten na renovatie',
    'Onderhoud en nazorg',
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="space-y-8">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Keukenblad kitten in {location}</h2>
          <p className="text-gray-700 mb-4">
            Weekend Klussen is uw specialist voor keukenblad kitten in {location}. Keukenblad kitten is essentieel voor een goede afdichting en voorkomt vochtproblemen, schimmelvorming en beschadiging van uw keukenblad. Onze ervaren vakmannen zorgen voor een perfecte afwerking met hoogwaardige kitmaterialen.
          </p>
          <p className="text-gray-700 mb-4">
            Wij verzorgen keukenblad kitten voor alle soorten keukenbladen in {location} en omgeving. Of het nu gaat om een granieten, composiet, houten of kunststof keukenblad - wij zorgen voor een strakke en duurzame afwerking. Oude kit wordt zorgvuldig verwijderd en vervangen door nieuwe, hoogwaardige kit die bestand is tegen vocht, warmte en schoonmaakmiddelen.
          </p>
          <p className="text-gray-700">
            Goed kitten van uw keukenblad voorkomt vochtdoorslag en zorgt voor een hygiënische en makkelijk schoon te houden keuken. Onze vakmannen in {location} werken met precisie en zorgen voor een perfecte afwerking die jarenlang meegaat.
          </p>
        </motion.section>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Onze keukenblad kitten diensten in {location}</h2>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Waarom keukenblad kitten belangrijk is</h2>
          <p className="text-gray-700 mb-4">
            Keukenblad kitten biedt tal van voordelen:
          </p>
          ...
          <p className="text-gray-700">
            Door professioneel keukenblad kitten voorkomt u problemen en zorgt u voor een perfecte afwerking. Onze vakmannen in {location} gebruiken hoogwaardige kitmaterialen die bestand zijn tegen vocht, warmte en schoonmaakmiddelen.
          </p>
        </motion.section>
        ...
        {nearbyCities.length > 0 && (
          ...
          >
            ...
            <p className="text-gray-700 mb-4">
              Weekend Klussen verzorgt keukenblad kitten niet alleen in {location}, maar ook in de omliggende gemeenten en steden:
            </p>
        ...
        <motion.section
          ...
          className="bg-white p-6 sm:p-8 rounded-xl border border-gray-100 shadow-sm"
        >
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Waarom kiezen voor Weekend Klussen voor keukenblad kitten in {location}?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Jarenlange ervaring met keukenblad kitten in {location}.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-brown-100 rounded-lg flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Altijd garantie op onze keukenblad kitten werkzaamheden.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-brown-100 rounded-lg flex items-center justify-center shrink-0">
        ...
        >
          <h2 className="text-2xl font-bold mb-4">Vrijblijvend offerte voor keukenblad kitten in {location}</h2>
          <p className="mb-6 text-brown-100">
            Heeft u een keukenblad dat gekit moet worden in {location}? Vraag vrijblijvend een gratis offerte aan. Wij komen graag langs voor een inspectie en reageren binnen 24 uur met een duidelijke prijsopgave zonder verplichtingen.
          </p>
