...
export const metadata: Metadata = {
  title: 'Badkamer Renoveren | Weekend Klussen Badkamer Renovatie Zuid-Holland',
  description:
    'Badkamer renoveren in Zuid-Holland en omgeving. Weekend Klussen verzorgt complete badkamer renovaties van ontwerp tot oplevering. Sanitair installatie, tegelwerk, badkamer meubels en meer. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function BadkamerRenoverenPage() {
  return (
