...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en installeren in Leiden. Weekend Klussen verzorgt professionele douchecabine montage en installatie in Leiden. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMonterenLeidenPage() {
  return (
