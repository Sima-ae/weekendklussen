...
export const metadata: Metadata = generatePageMetadata({
  title: 'Slotenmaker Rotterdam | Weekend Klussen 24/7 Slotenmaker Rotterdam',
  description: '24/7 slotenmaker service in Rotterdam. Slotenmaker voor sloten reparatie, sleutels maken, inbraakbeveiliging en meer. Snelle service, vaste prijzen. Gratis offerte.',
  location: 'Rotterdam',
  service: 'slotenmaker',
  keywords: ['slotenmaker Rotterdam', '24/7 slotenmaker Rotterdam', 'slotenmaker service Rotterdam', 'slot reparatie Rotterdam'],
});

export default function SlotenmakerRotterdamPage() {
  return (
    <main className="relative w-full flex-1 flex flex-col pt-14 sm:pt-16">
      ...
      <ServiceLocationContent
        location="Rotterdam"
        service="Slotenmaker"
        title="Slotenmaker Rotterdam 24/7"
        description="24/7 slotenmaker service in Rotterdam. Weekend Klussen staat dag en nacht voor u klaar bij sloten en sleutel problemen in Rotterdam. Snelle service met vaste prijzen."
        serviceDescription="Weekend Klussen biedt 24/7 slotenmaker service in Rotterdam. Of u nu buitengesloten bent, een slot kapot is, nieuwe sleutels nodig heeft, of inbraakbeveiliging wilt - onze ervaren slotenmakers staan dag en nacht voor u klaar in Rotterdam. Wij reageren snel en lossen uw probleem professioneel op."
        serviceDetails={[
