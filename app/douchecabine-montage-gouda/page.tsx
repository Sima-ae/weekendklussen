...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en plaatsen in Gouda. Weekend Klussen verzorgt professionele douchecabine montage en installatie in Gouda. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMontageGoudaPage() {
  return (
