...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en installeren in Zuid-Holland en omgeving. Weekend Klussen verzorgt professionele douchecabine montage en installatie. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMonterenPage() {
  return (
