...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en installeren in Den Haag. Weekend Klussen verzorgt professionele douchecabine montage en installatie in Den Haag. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMonterenDenHaagPage() {
  return (
