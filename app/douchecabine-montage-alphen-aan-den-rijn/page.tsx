...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en plaatsen in Alphen aan den Rijn. Weekend Klussen verzorgt professionele douchecabine montage en installatie in Alphen aan den Rijn. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMontageAlphenAanDenRijnPage() {
  return (
