...
export const metadata: Metadata = {
  title: 'Badkamer Renovatie Delft | Weekend Klussen Badkamer Renovatie Delft',
  description:
    'Badkamer renovatie in Delft. Weekend Klussen verzorgt complete badkamer renovaties in Delft van ontwerp tot oplevering. Sanitair installatie, tegelwerk, badkamer meubels en meer. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function BadkamerRenovatieDelftPage() {
  return (
