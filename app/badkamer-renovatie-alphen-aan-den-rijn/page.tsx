...
export const metadata: Metadata = {
  title: 'Badkamer Renovatie Alphen aan den Rijn | Weekend Klussen Badkamer Renovatie Alphen aan den Rijn',
  description:
    'Badkamer renovatie in Alphen aan den Rijn. Weekend Klussen verzorgt complete badkamer renovaties in Alphen aan den Rijn van ontwerp tot oplevering. Sanitair installatie, tegelwerk, badkamer meubels en meer. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function BadkamerRenovatieAlphenAanDenRijnPage() {
  return (
