...
export const metadata: Metadata = {
  ...
  description:
    'Douchecabine monteren en installeren in Dordrecht. Weekend Klussen verzorgt professionele douchecabine montage en installatie in Dordrecht. Alle types douchecabines, van inbouw tot opbouw. Vaste prijzen, garantie en snelle service. Gratis offerte.',
};

export default function DouchecabineMonterenDordrechtPage() {
  return (
